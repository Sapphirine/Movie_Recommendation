...
/**
 * <p>Distributed precomputation of the item-item-similarities</p>
 *
 * <p>Preferences in the input file should look like {@code userID(or tagID),itemID[,preferencevalue]}</p>
 *
 * <p>
 ...
 */
public final class DistributedRecommenderReasonJob extends AbstractJob {

  public static final String ITEM_ID_INDEX_PATH_STR = DistributedRecommenderReasonJob.class.getName() + ".itemIDIndexPathStr";
  public static final String MAX_SIMILARITIES_PER_ITEM = DistributedRecommenderReasonJob.class.getName() + ".maxSimilarItemsPerItem";
